        ...
        <div class="row">
            <form class="row g-3" method="POST" action="guarda.php" autocomplete="off">
                ...
                <div class="col-md-4 d-flex align-items-center gap-4">
                    ...
                    <input class="form-control" type="text" id="codigo" name="codigo" require autofocus>
                </div>

                <div class="col-md-8 d-flex align-items-center gap-4">
                    <label for="descripcion" class="form-label">Descripción</label>

                    <input class="form-control" type="text" id="descripcion" name="descripcion" require>
                </div>
